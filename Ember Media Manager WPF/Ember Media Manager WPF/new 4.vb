                    ...
                    If Not ModulesManager.Instance.ScrapeImage_Movie(DBScrapeMovie, SearchResultsContainer, tScrapeItem.ScrapeModifiers, Args.ScrapeList.Count = 1) Then
                        If Args.ScrapeType = Enums.ScrapeType.SingleScrape AndAlso Master.eSettings.MovieImagesDisplayImageSelect Then
                            Using dImgSelect As New dlgImgSelect
                                If dImgSelect.ShowDialog(DBScrapeMovie, SearchResultsContainer, tScrapeItem.ScrapeModifiers) = WinForms.DialogResult.OK Then
                    ...
                    If Not ModulesManager.Instance.ScrapeTheme_Movie(DBScrapeMovie, Enums.ModifierType.MainTheme, SearchResults) Then
                        If Args.ScrapeType = Enums.ScrapeType.SingleScrape Then
                            Using dThemeSelect As New dlgThemeSelect
                                If dThemeSelect.ShowDialog(DBScrapeMovie, SearchResults, AdvancedSettings.GetBooleanSetting("UseAsVideoPlayer", False, "generic.EmberCore.VLCPlayer")) = WinForms.DialogResult.OK Then
                    ...
                    If Not ModulesManager.Instance.ScrapeTrailer_Movie(DBScrapeMovie, Enums.ModifierType.MainTrailer, SearchResults) Then
                        If Args.ScrapeType = Enums.ScrapeType.SingleScrape Then
                            Using dTrailerSelect As New dlgTrailerSelect
                                'note msavazzi why is always False with Player? If dTrailerSelect.ShowDialog(DBScrapeMovie, SearchResults, False, True, False) = WinForms.DialogResult.OK Then
                                'DanCooper: the VLC COM interface is/was not able to call in multithread
                                If dTrailerSelect.ShowDialog(DBScrapeMovie, SearchResults, False, True, AdvancedSettings.GetBooleanSetting("UseAsVideoPlayer", False, "generic.EmberCore.VLCPlayer")) = WinForms.DialogResult.OK Then
            ...
            If Not Cancelled Then
                ...
                If tScrapeItem.ScrapeModifiers.MainBanner OrElse
                    ...
                    If Not ModulesManager.Instance.ScrapeImage_MovieSet(DBScrapeMovieSet, SearchResultsContainer, tScrapeItem.ScrapeModifiers) Then
                        If Args.ScrapeType = Enums.ScrapeType.SingleScrape AndAlso Master.eSettings.MovieImagesDisplayImageSelect Then
                            Using dImgSelect As New dlgImgSelect
                                If dImgSelect.ShowDialog(DBScrapeMovieSet, SearchResultsContainer, tScrapeItem.ScrapeModifiers) = WinForms.DialogResult.OK Then
            ...
            If Not Cancelled Then
                ...
                If Not ModulesManager.Instance.ScrapeImage_TV(DBScrapeShow, SearchResultsContainer, tScrapeItem.ScrapeModifiers, Args.ScrapeList.Count = 1) Then
                    If Args.ScrapeType = Enums.ScrapeType.SingleScrape AndAlso Master.eSettings.TVImagesDisplayImageSelect Then
                        Using dImgSelect As New dlgImgSelect
                            If dImgSelect.ShowDialog(DBScrapeShow, SearchResultsContainer, tScrapeItem.ScrapeModifiers) = WinForms.DialogResult.OK Then
                ...
                If tScrapeItem.ScrapeModifiers.MainTheme Then
                    ...
                    If Not ModulesManager.Instance.ScrapeTheme_TVShow(DBScrapeShow, Enums.ModifierType.MainTheme, SearchResults) Then
                        If Args.ScrapeType = Enums.ScrapeType.SingleScrape Then
                            Using dThemeSelect As New dlgThemeSelect
                                If dThemeSelect.ShowDialog(DBScrapeShow, SearchResults, AdvancedSettings.GetBooleanSetting("UseAsVideoPlayer", False, "generic.EmberCore.VLCPlayer")) = WinForms.DialogResult.OK Then
            ...
            If Not Cancelled Then
                ...
                If tScrapeItem.ScrapeModifiers.EpisodeFanart OrElse
                    ...
                    If Not ModulesManager.Instance.ScrapeImage_TV(DBScrapeEpisode, SearchResultsContainer, tScrapeItem.ScrapeModifiers, Args.ScrapeList.Count = 1) Then
                        If Args.ScrapeType = Enums.ScrapeType.SingleScrape AndAlso Master.eSettings.TVImagesDisplayImageSelect Then
                            Using dImgSelect As New dlgImgSelect
                                If dImgSelect.ShowDialog(DBScrapeEpisode, SearchResultsContainer, tScrapeItem.ScrapeModifiers) = WinForms.DialogResult.OK Then
            ...
            If Not Cancelled Then
                ...
                If tScrapeItem.ScrapeModifiers.AllSeasonsBanner OrElse
                    ...
                    If Not ModulesManager.Instance.ScrapeImage_TV(DBScrapeSeason, SearchResultsContainer, tScrapeItem.ScrapeModifiers, Args.ScrapeList.Count = 1) Then
                        If Args.ScrapeType = Enums.ScrapeType.SingleScrape AndAlso Master.eSettings.TVImagesDisplayImageSelect Then
                            Using dImgSelect As New dlgImgSelect
                                If dImgSelect.ShowDialog(DBScrapeSeason, SearchResultsContainer, tScrapeItem.ScrapeModifiers) = WinForms.DialogResult.OK Then
    ...
    Private Sub CleanFiles()
        ...
        '        End If
        '    End With
        '    If MessageBox.Show(sWarning, Master.eLang.GetString(104, "Are you sure?"), MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = WinForms.DialogResult.Yes Then
    ...
    Private Sub cmnuShowOpenFolder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuShowOpenFolder.Click
        If dgvTVShows.SelectedRows.Count > 0 Then
            ...
            If dgvTVShows.SelectedRows.Count > 10 Then
                If Not Forms.MessageBox.Show(String.Format(Master.eLang.GetString(635, "You have selected {0} folders to open. Are you sure you want to do this?"), dgvTVShows.SelectedRows.Count), Master.eLang.GetString(104, "Are You Sure?"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = WinForms.DialogResult.Yes Then doOpen = False
            End If
    ...
    Private Sub cmnuEpisodeChange_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuEpisodeChange.Click
        ...
        If Not ModulesManager.Instance.ScrapeData_TVShow(tmpShow, ScrapeModifiers, Enums.ScrapeType.SingleScrape, Master.DefaultOptions_TV, True) Then
            If tmpShow.Episodes.Count > 0 Then
                ...
                If dlgChangeEp.ShowDialog = WinForms.DialogResult.OK Then
                ...
                End If
            Else
                Forms.MessageBox.Show(Master.eLang.GetString(943, "There are no known episodes for this show. Scrape the show, season, or episode and try again."), Master.eLang.GetString(944, "No Known Episodes"), MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
        End If
        ...
        Try
            ...
            If SeasonsToDelete.Count > 0 Then
                Using dlg As New dlgDeleteConfirm
                    If dlg.ShowDialog(SeasonsToDelete, Enums.ContentType.TVSeason) = WinForms.DialogResult.OK Then
    ...
    Private Sub cmnuEpisodeRemoveFromDisk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuEpisodeRemoveFromDisk.Click
        Try
            ...
            If EpsToDelete.Count > 0 Then
                Using dlg As New dlgDeleteConfirm
                    If dlg.ShowDialog(EpsToDelete, Enums.ContentType.TVEpisode) = WinForms.DialogResult.OK Then
    ...
    Private Sub cmnuShowRemoveFromDisk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuShowRemoveFromDisk.Click
        Try
            ...
            If ShowsToDelete.Count > 0 Then
                Using dlg As New dlgDeleteConfirm
                    If dlg.ShowDialog(ShowsToDelete, Enums.ContentType.TVShow) = WinForms.DialogResult.OK Then
                        FillList(False, False, True)
                    End If
                End Using
            End If
    ...
    Private Sub cmnuEpisodeOpenFolder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuEpisodeOpenFolder.Click
        If dgvTVEpisodes.SelectedRows.Count > 0 Then
            ...
            If dgvTVEpisodes.SelectedRows.Count > 10 Then
                If Not Forms.MessageBox.Show(String.Format(Master.eLang.GetString(635, "You have selected {0} folders to open. Are you sure you want to do this?"), dgvTVEpisodes.SelectedRows.Count), Master.eLang.GetString(104, "Are You Sure?"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = WinForms.DialogResult.Yes Then doOpen = False
            End If
    ...
    Private Sub cmnuMovieSetNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuMovieSetNew.Click
        ...
        Using dNewSet As New dlgNewSet()
            If dNewSet.ShowDialog(tmpDBMovieSet) = WinForms.DialogResult.OK Then
    ...
    Private Sub cmnuSeasonOpenFolder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuSeasonOpenFolder.Click
        If dgvTVSeasons.SelectedRows.Count > 0 Then
            ...
            If dgvTVSeasons.SelectedRows.Count > 10 Then
                If Not Forms.MessageBox.Show(String.Format(Master.eLang.GetString(635, "You have selected {0} folders to open. Are you sure you want to do this?"), dgvTVSeasons.SelectedRows.Count), Master.eLang.GetString(104, "Are You Sure?"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = WinForms.DialogResult.Yes Then doOpen = False
            End If
    ...
    Private Sub createGenreThumbs(ByVal genres As List(Of String))
        ...
        For i As Integer = 0 To genres.Count - 1
            Try
                ...
                pbGenre(i).Size = new drawing.size(62, 94)
    ...
    Private Sub cmnuMovieRemoveFromDisk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuMovieRemoveFromDisk.Click
        ...
        If MoviesToDelete.Count > 0 Then
            Using dlg As New dlgDeleteConfirm
                If dlg.ShowDialog(MoviesToDelete, Enums.ContentType.Movie) = WinForms.DialogResult.OK Then
                    FillList(True, True, False)
                End If
            End Using
        End If
    ...
    Private Sub dgvMovies_CellPainting(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellPaintingEventArgs) Handles dgvMovies.CellPainting
        ...
        If (colName = "BannerPath" OrElse colName = "ClearArtPath" OrElse colName = "ClearLogoPath" OrElse
            ...
            Dim pt As dawing.Point = e.CellBounds.Location
        ...
        If (colName = "Imdb" OrElse colName = "ListTitle" OrElse colName = "MPAA" OrElse colName = "OriginalTitle" OrElse
            ...
            If Convert.ToBoolean(dgvMovies.Item("Mark", e.RowIndex).Value) Then
                e.CellStyle.ForeColor = Drawing.Color.Crimson
                e.CellStyle.Font = New Font("Segoe UI", 9, FontStyle.Bold)
                e.CellStyle.SelectionForeColor = Drawing.Color.Crimson
            ElseIf Convert.ToBoolean(dgvMovies.Item("New", e.RowIndex).Value) Then
                e.CellStyle.ForeColor = Drawing.Color.Green
                e.CellStyle.Font = New Font("Segoe UI", 9, FontStyle.Bold)
                e.CellStyle.SelectionForeColor = Drawing.Color.Green
            ...
            Else
                ...
                e.CellStyle.SelectionForeColor = Drawing.Color.FromKnownColor(KnownColor.HighlightText)
            End If
        End If
        ...
        If e.ColumnIndex >= 2 AndAlso e.RowIndex >= 0 Then
            ...
            If Convert.ToBoolean(dgvMovies.Item("Lock", e.RowIndex).Value) Then
                e.CellStyle.BackColor = Drawing.Color.LightSteelBlue
                e.CellStyle.SelectionBackColor = Drawing.Color.DarkTurquoise
            ElseIf Convert.ToBoolean(dgvMovies.Item("OutOfTolerance", e.RowIndex).Value) Then
                ...
                e.CellStyle.SelectionBackColor = Drawing.Color.DarkMagenta
            Else
                e.CellStyle.BackColor = Drawing.Color.White
                e.CellStyle.SelectionBackColor = Drawing.Color.FromKnownColor(KnownColor.Highlight)
            End If
    ...
    Private Sub dgvTVEpisodes_CellPainting(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellPaintingEventArgs) Handles dgvTVEpisodes.CellPainting
        ...
        If (colName = "Aired" OrElse colName = "Episode" OrElse colName = "Season" OrElse
            ...
            If Convert.ToInt64(dgvTVEpisodes.Item("idFile", e.RowIndex).Value) = -1 Then
                e.CellStyle.ForeColor = Drawing.Color.Gray
                e.CellStyle.Font = New Font("Segoe UI", 9, FontStyle.Regular)
                e.CellStyle.SelectionForeColor = Drawing.Color.LightGray
        ...
        If e.ColumnIndex >= 2 AndAlso e.RowIndex >= 0 Then
            ...
            If Convert.ToInt64(dgvTVEpisodes.Item("idFile", e.RowIndex).Value) = -1 Then
                e.CellStyle.BackColor = Drawing.Color.White
                e.CellStyle.SelectionBackColor = Drawing.Color.DarkGray
        ...
        If DBMovie.IsOnline OrElse FileUtils.Common.CheckOnlineStatus_Movie(DBMovie, True) Then
            Using dEditMovie As New dlgEditMovie
                ...
                Select Case dEditMovie.ShowDialog(DBMovie)
                    ...
                    Case WinForms.DialogResult.Retry
                        Dim ScrapeModifiers As New Structures.ScrapeModifiers
                        Functions.SetScrapeModifiers(ScrapeModifiers, Enums.ModifierType.All, True)
                        CreateScrapeList_Movie(Enums.ScrapeType.SingleScrape, Master.DefaultOptions_Movie, ScrapeModifiers)
                    Case WinForms.DialogResult.Abort
                        Dim ScrapeModifiers As New Structures.ScrapeModifiers
                        Functions.SetScrapeModifiers(ScrapeModifiers, Enums.ModifierType.DoSearch, True)
                        Functions.SetScrapeModifiers(ScrapeModifiers, Enums.ModifierType.All, True)
                        CreateScrapeList_Movie(Enums.ScrapeType.SingleScrape, Master.DefaultOptions_Movie, ScrapeModifiers)
    ...
    Private Sub FillScreenInfoWithImages()
        ...
        If MainFanart.Image IsNot Nothing OrElse MainFanart.LoadFromMemoryStream Then
            ...
            If pbFanArt.Image IsNot Nothing AndAlso Master.eSettings.GeneralShowImgDims Then
                ...
                ImageUtils.DrawGradEllipse(g, rect, Drawing.Color.FromArgb(250, 120, 120, 120), Color.FromArgb(0, 255, 255, 255))
                g.DrawString(strSize, New Font("Arial", 8, FontStyle.Bold), New SolidBrush(Drawing.Color.White), Convert.ToInt32((pbFanArt.Image.Width - lenSize) / 2), pbFanArt.Height - 20)
            End If
        Else
    ...
    Private Sub frmMain_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        Try
            ...
            If ModulesManager.Instance.QueryAnyGenericIsBusy Then
                If Forms.MessageBox.Show("One or more modules are busy. Do you want to wait until all tasks are finished?", "One or more external Modules are busy", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = WinForms.DialogResult.Yes Then
                ...
                Select Case _params(0).ToString
                    Case "addmoviesource"
                        Using dSource As New dlgSourceMovie
                            If dSource.ShowDialog(CStr(_params(1)), CStr(_params(1))) = WinForms.DialogResult.OK Then
                                Master.DB.Load_Sources_Movie()
                                SetMenus(True)
                            End If
                        End Using
    ...
    Public Sub ChangeToolStripLabel(control As WinForms.ToolStripLabel, bVisible As Boolean, strValue As String)
    ...
    Private Sub ChangeToolStripProgressBar(control As WinForms.ToolStripProgressBar,
                                           bVisible As Boolean,
                                           iMaximum As Integer,
                                           iMinimum As Integer,
                                           iValue As Integer,
    ...
    Private Sub mnuDataFieldTrailerURL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDataFieldTrailerURL.Click
        ...
        Using dEditDataField As New dlgEditDataField
            If dEditDataField.ShowDialog(Master.eLang.GetString(227, "Trailer URL")) = WinForms.DialogResult.OK Then
    ...
    Private Sub mnuDataFieldVideosource_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuDataFieldVideosource.Click
        ...
        Using dEditDataField As New dlgEditDataField
            If dEditDataField.ShowDialog(Master.eLang.GetString(824, "Video Source")) = WinForms.DialogResult.OK Then
                strNewValue = dEditDataField.Result
                Using SQLtransaction As SQLite.SQLiteTransaction = Master.DB.MyVideosDBConn.BeginTransaction()
                    Select Case _SelectedContentType
                        Case "movie"
    ...
    Private Sub MoveMPAA()
        ...
        pnlMPAA.Size = new drawing.size(pbMPAA.Width + 10, pbMPAA.Height + 10)
    ...
    Private Sub cmnuMovieOpenFolder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmnuMovieOpenFolder.Click
        If dgvMovies.SelectedRows.Count > 0 Then
            ...
            If dgvMovies.SelectedRows.Count > 10 Then
                If Not Forms.MessageBox.Show(String.Format(Master.eLang.GetString(635, "You have selected {0} folders to open. Are you sure you want to do this?"), dgvMovies.SelectedRows.Count), Master.eLang.GetString(104, "Are You Sure?"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = WinForms.DialogResult.Yes Then doOpen = False
            End If
        ...
        Try
            If dgvMovieSets.SelectedRows.Count > 0 Then
                ...
                If dgvMovieSets.SelectedRows.Count > 10 Then
                    If Not Forms.MessageBox.Show(String.Format(Master.eLang.GetString(635, "You have selected {0} folders to open. Are you sure you want to do this?"), dgvMovieSets.SelectedRows.Count), Master.eLang.GetString(104, "Are You Sure?"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) = WinForms.DialogResult.Yes Then doOpen = False
                End If
                If doOpen Then
                    For Each sRow As DataGridViewRow In dgvMovieSets.SelectedRows
                        If Not String.IsNullOrEmpty(sRow.Cells("TMDBColID").Value.ToString) Then
                    ...
                    Case Enums.ContentType.Movie
                        ...
                        If Not ModulesManager.Instance.ScrapeImage_Movie(tmpDBElement, aContainer, ScrapeModifiers, True) Then
                            If aContainer.MainBanners.Count > 0 Then
                                ...
                                If dlgImgS.ShowDialog(tmpDBElement, aContainer, ScrapeModifiers) = WinForms.DialogResult.OK Then
                                ...
                                End If
                            Else
                                Forms.MessageBox.Show(Master.eLang.GetString(1363, "No Banners found"), String.Empty, MessageBoxButtons.OK, MessageBoxIcon.Information)
                            End If
                        End If
                        SetControlsEnabled(True)
                    Case Enums.ContentType.MovieSet
                        ...
                        If dgvTVShows.Focused Then
                            ...
                            If Not ModulesManager.Instance.ScrapeImage_TV(tmpDBElement, aContainer, ScrapeModifiers, True) Then
                                If aContainer.MainCharacterArts.Count > 0 Then
                                    ...
                                    End If
                                Else
                                    Forms.MessageBox.Show(Master.eLang.GetString(970, "No Fanarts found"), String.Empty, MessageBoxButtons.OK, MessageBoxIcon.Information)
                                End If
                            End If
                            SetControlsEnabled(True)
                    ...
                    Case Enums.ContentType.Movie
                        ...
                        If Not ModulesManager.Instance.ScrapeImage_Movie(tmpDBElement, aContainer, ScrapeModifiers, True) Then
                            If aContainer.MainClearArts.Count > 0 Then
                                ...
                                End If
                            Else
                                Forms.MessageBox.Show(Master.eLang.GetString(1102, "No ClearArts found"), String.Empty, MessageBoxButtons.OK, MessageBoxIcon.Information)
                            End If
                        End If
                        SetControlsEnabled(True)
                    Case Enums.ContentType.MovieSet
                    ...
                    Case Enums.ContentType.Movie
                        ...
                        If Not ModulesManager.Instance.ScrapeImage_Movie(tmpDBElement, aContainer, ScrapeModifiers, True) Then
                            If aContainer.MainClearLogos.Count > 0 Then
                                ...
                                End If
                            Else
                                Forms.MessageBox.Show(Master.eLang.GetString(1103, "No ClearLogos found"), String.Empty, MessageBoxButtons.OK, MessageBoxIcon.Information)
                            End If
                        End If
                        SetControlsEnabled(True)
                    Case Enums.ContentType.MovieSet
                    ...
                    Case Enums.ContentType.Movie
                        ...
                        If Not ModulesManager.Instance.ScrapeImage_Movie(tmpDBElement, aContainer, ScrapeModifiers, True) Then
                            If aContainer.MainDiscArts.Count > 0 Then
                                ...
                                End If
                            Else
                                Forms.MessageBox.Show(Master.eLang.GetString(1104, "No DiscArts found"), String.Empty, MessageBoxButtons.OK, MessageBoxIcon.Information)
                            End If
                        End If
                        SetControlsEnabled(True)
                    Case Enums.ContentType.MovieSet
                    ...
                    Case Enums.ContentType.Movie
                        ...
                        If Not ModulesManager.Instance.ScrapeImage_Movie(tmpDBElement, aContainer, ScrapeModifiers, True) Then
                            If aContainer.MainLandscapes.Count > 0 Then
                                ...
                                End If
                            Else
                                Forms.MessageBox.Show(Master.eLang.GetString(1197, "No Landscapes found"), String.Empty, MessageBoxButtons.OK, MessageBoxIcon.Information)
                            End If
                        End If
                        SetControlsEnabled(True)
                    Case Enums.ContentType.MovieSet
                    ...
                    Case Enums.ContentType.Movie
                        ...
                        If Not ModulesManager.Instance.ScrapeImage_Movie(tmpDBElement, aContainer, ScrapeModifiers, True) Then
                            If aContainer.MainPosters.Count > 0 Then
                                ...
                                End If
                            Else
                                Forms.MessageBox.Show(Master.eLang.GetString(972, "No Posters found"), String.Empty, MessageBoxButtons.OK, MessageBoxIcon.Information)
                            End If
                        End If
                        SetControlsEnabled(True)
                    Case Enums.ContentType.MovieSet
    ...
    Private Function Reload_Movie(ByVal ID As Long, ByVal BatchMode As Boolean, ByVal showMessage As Boolean) As Boolean
        ...
        Else
            If showMessage AndAlso Forms.MessageBox.Show(String.Concat(Master.eLang.GetString(587, "This file is no longer available"), ".", Environment.NewLine,
                                                     ...
                                                     MessageBoxButtons.YesNo, MessageBoxIcon.Question) = WinForms.DialogResult.Yes Then
    ...
    Private Function Reload_TVShow(ByVal ID As Long, ByVal BatchMode As Boolean, ByVal showMessage As Boolean, ByVal reloadFull As Boolean) As Boolean
        ...
        Else
            If showMessage AndAlso Forms.MessageBox.Show(String.Concat(Master.eLang.GetString(719, "This path is no longer available"), ".", Environment.NewLine,
                                                         Master.eLang.GetString(703, "Whould you like to remove it from the library?")),
    ...
    Private Sub RunFilter_Shows(Optional ByVal doFill As Boolean = False)
        If Visible Then
            ...
            If doFill Then
                FillList(False, False, True)
                ModulesManager.Instance.RuntimeObjects.FilterTVShowsSearch = StringUtils.ConvertToValidFilterString(txtSearchShows.Text)
            ...
            Using SQLNewcommand As SQLite.SQLiteCommand = Master.DB.MyVideosDBConn.CreateCommand()
                ...
                Using SQLReader As SQLite.SQLiteDataReader = SQLNewcommand.ExecuteReader()
                    While SQLReader.Read
                        ...
                        mnuItem.ForeColor = If(Convert.ToBoolean(SQLReader("bExclude")), Drawing.Color.Gray, Drawing.Color.Black)
        ...
        If Not dresult.DidCancel Then
            ...
            If dresult.NeedsDBClean_Movie OrElse
                ...
                If dresult.NeedsDBClean_Movie OrElse dresult.NeedsDBClean_TV Then
                    If Forms.MessageBox.Show(String.Format(Master.eLang.GetString(1007, "You've changed a setting that makes it necessary that the database is cleaned up. Please make sure that all sources are available!{0}{0}Should the process be continued?"), Environment.NewLine), Master.eLang.GetString(356, "Warning"), MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = WinForms.DialogResult.Yes Then
            ...
            If dresult.NeedsRestart Then
                ...
                If dRestart.ShowDialog = WinForms.DialogResult.OK Then
                    Application.Restart()
                End If
            End If
        Else
    ...
    Private Sub CheckUpdatesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuMainHelpUpdate.Click
        If Functions.CheckNeedUpdate() Then
            ...
            End Using
        Else
            Forms.MessageBox.Show(Master.eLang.GetString(851, "No Updates at this time"), "Updates", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
    ...
    Private Sub lblIMDBHeader_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles lblIMDBHeader.MouseEnter
        If Not String.IsNullOrEmpty(txtIMDBID.Text) Then
            ...
            lblIMDBHeader.ForeColor = Drawing.Color.FromArgb(Not lblIMDBHeader.ForeColor.R, Not lblIMDBHeader.ForeColor.G, Not lblIMDBHeader.ForeColor.B)
            Cursor = Cursors.Hand
        End If
    End Sub
    ...
    Private Sub lblIMDBHeader_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles lblIMDBHeader.MouseLeave
        If Not lblIMDBHeader.Tag Is Nothing Then
            lblIMDBHeader.ForeColor = DirectCast(lblIMDBHeader.Tag, Drawing.Color)
            Cursor = Cursors.Default
    ...
    Private Sub lblTMDBHeader_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles lblTMDBHeader.MouseEnter
        If Not String.IsNullOrEmpty(txtTMDBID.Text) Then
            ...
            lblTMDBHeader.ForeColor = Drawing.Color.FromArgb(Not lblTMDBHeader.ForeColor.R, Not lblTMDBHeader.ForeColor.G, Not lblTMDBHeader.ForeColor.B)
            Cursor = Cursors.Hand
        End If
    End Sub
    ...
    Private Sub lblTMDBHeader_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles lblTMDBHeader.MouseLeave
        If Not lblTMDBHeader.Tag Is Nothing Then
            lblTMDBHeader.ForeColor = DirectCast(lblTMDBHeader.Tag, Drawing.Color)
            Cursor = Cursors.Default
    ...
    Private Sub bwCheckVersion_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwCheckVersion.DoWork
        Invoke(New UpdatemnuVersionDel(AddressOf UpdatemnuVersion), String.Concat(Master.strVersionOverwrite, " ", If(Master.is32Bit, "x86", "x64")), Drawing.Color.Green)
        'Try
    ...
    Public Delegate Sub UpdatemnuVersionDel(sText As String, sForeColor As Drawing.Color)

    Private Sub UpdatemnuVersion(sText As String, sForeColor As Drawing.Color)
